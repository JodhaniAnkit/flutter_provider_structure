...
class ProductProvider extends ChangeNotifier {
  ...
  final List<ProductModel> _ipad = [
    ProductModel(
      ...
      price: 800,
      image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQT2_RAwg7_oKa2jQ_WSqACxd8BfU4y-1WkAw&s",
      isAvailable: true,
    ),
    ProductModel(
      name: "iPad Pro M2",
      price: 2200,
      image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY3R8WggxSOLapMmOjHz2uCaRJ2Ud01lMQdQ&s",
      isAvailable: true,
    )
  ];
  ...
  final List<ProductModel> _iphone = [
    ProductModel(
      ...
      price: 999,
      image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQojzFYENBDAsR2FwrlLseEMPNChmnEJKShWQ&s",
      isAvailable: true,
    ),
    ProductModel(
      name: "iPhone 11",
      price: 799,
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRb_yLC-5FIiIA1481PjnLfm-L5hhtCDqeMOw&s",
      isAvailable: true,
    )
  ];
